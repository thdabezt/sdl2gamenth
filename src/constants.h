...
// Ina
const int ina1Health = 80; const int ina1Damage = 8; const float ina1Speed = 1.7f; const int ina1Exp = 20;
const int ina2Health = 120; const int ina2Damage = 12; const float ina2Speed = 1.7f; const int ina2Exp = 30;
const int ina3Health = 180; const int ina3Damage = 18; const float ina3Speed = 1.7f; const int ina3Exp = 40;

// KFC
const int kfc1Health = 50; const int kfc1Damage = 12; const float kfc1Speed = 2.5f; const int kfc1Exp = 20;
const int kfc2Health = 100; const int kfc2Damage = 18; const float kfc2Speed = 2.5; const int kfc2Exp = 30;

// Skeleton
const int skeleton1Health = 90; const int skeleton1Damage = 10; const float skeleton1Speed = 1.0f; const int skeleton1Exp = 14;
const int skeleton2Health = 130; const int skeleton2Damage = 14; const float skeleton2Speed = 1.1f; const int skeleton2Exp = 20;
...
const int skeletonShieldHealth = 500; const int skeletonShieldDamage = 10; const float skeletonShieldSpeed = 0.9f; const int skeletonShieldExp = 50;
const int eliteSkeletonShieldHealth = 800; const int eliteSkeletonShieldDamage = 10; const float eliteSkeletonShieldSpeed = 0.8f; const int eliteSkeletonShieldExp = 100;

// Zombie
const int zombieHealth = 60; const int zombieDamage = 10; const float zombieSpeed = 1.0f; const int zombieExp = 5;
